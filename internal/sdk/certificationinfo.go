...
func newCertificationInfo(sdkConfig sdkConfiguration) *CertificationInfo {
...
func (s *CertificationInfo) GetCertInfoCertInfoGet(ctx context.Context, opts ...operations.Option) (*operations.GetCertInfoCertInfoGetResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/cert_info")
	if err != nil {
	...
	res := &operations.GetCertInfoCertInfoGetResponse{
